# Setup fzf
# ---------
if [[ ! "$PATH" == ${HOME}/.local/share/mise/installs/fzf/0.65.1/bin* ]]; then
  # Key bindings
  source "${HOME}/.local/share/mise/installs/fzf/0.65.1/shell/key-bindings.zsh"
# Auto-completion
  source "${HOME}/.local/share/mise/installs/fzf/0.65.1/shell/completion.zsh"
fi
