...
-- Rename
keymap("n", "<leader>lrn", "<cmd>Lspsaga rename<CR>")

-- Rename word in whole project
keymap("n", "<leader>lrp", "<cmd>Lspsaga rename ++project<CR>")
...
keymap("n", "<leader>lsl", "<cmd>Lspsaga show_line_diagnostics<CR>")

-- Show cursor diagnostic
-- also like show_line_diagnostics  support pass ++unfocus
keymap("n", "<leader>lsc", "<cmd>Lspsaga show_cursor_diagnostics<CR>")
...
keymap("n", "<leader>l]", "<cmd>Lspsaga diagnostic_jump_next<CR>")
...
keymap("n", "<leader>lh", "<cmd>Lspsaga hover_doc<CR>")
...
-- Float terminal
keymap({ "n", "t" }, "<C-d>", "<cmd>Lspsaga term_toggle<CR>")
